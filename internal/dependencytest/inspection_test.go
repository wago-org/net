...
import (
	...
	dhcpv6fixture "github.com/wago-org/net/internal/dependencytest/testdata/dhcpv6"
	...
	icmpv6fixture "github.com/wago-org/net/internal/dependencytest/testdata/icmpv6"
...
func TestFixtureRuntimeInspection(t *testing.T) {
	tests := []struct {
		...
		{name: "icmpv6", newNetwork: icmpv6fixture.Network, capabilities: []wago.Capability{wagonet.CapICMPv6, wagonet.CapInfo}, imports: map[string]int{wagonet.Module: 1, wagonet.ICMPv6Module: 14}},
		...
		{name: "dhcpv6", newNetwork: dhcpv6fixture.Network, capabilities: []wago.Capability{wagonet.CapDHCPv6, wagonet.CapInfo}, imports: map[string]int{wagonet.Module: 1, wagonet.DHCPv6Module: 7}},
