...
func TestTLSFixtureRuntimeInspection(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "tls", newNetwork: tlsfixture.Network, capabilities: []wago.Capability{wagonet.CapInfo, wagonet.CapTLS}, imports: map[string]int{wagonet.Module: 1, wagonet.TLSModule: 14}},
		{name: "tcp_tls", newNetwork: tcptlsfixture.Network, capabilities: []wago.Capability{wagonet.CapInfo, wagonet.CapTCP, wagonet.CapTLS}, imports: map[string]int{wagonet.Module: 1, wagonet.TCPModule: 11, wagonet.TLSModule: 14}},
	} {
