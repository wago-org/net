...
const (
	...
	readinessMask = ReadyReadable | ReadyWritable | ReadyAccept | ReadyConnected | ReadyDNSResult | ReadyICMPv4Reply | ReadyNTPResult | ReadyMDNSResult | ReadyMDNSAnnouncement | ReadyDHCPv4Lease | ReadyLinkLocal4Result | ReadyICMPv6Reply | ReadyICMPv6Neighbor | ReadyDHCPv6Result | ReadyError | ReadyClosed
)
