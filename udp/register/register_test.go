...
import (
	...
	netregister "github.com/wago-org/net/udp/register"
	wago "github.com/wago-org/wago"
	"github.com/wago-org/wago/src/core/compiler/wasm"
	"github.com/wago-org/wago/tests/wasmtest"
)

func TestUDPFactoryHasExactRuntimeSurface(t *testing.T) {
	...
	assertImportCounts(t, runtime, map[string]int{wagonet.Module: 1, wagonet.UDPModule: 6})
	assertUnresolved(t, runtime, wagonet.TCPModule, wagonet.CapTCP)
	assertUnresolved(t, runtime, wagonet.DNSModule, wagonet.CapDNS)
}
