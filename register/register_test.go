...
func TestAllProtocolFactoryHasExactRuntimeSurface(t *testing.T) {
	...
	wantCapabilities := []wago.Capability{wagonet.CapDNS, wagonet.CapICMPv4, wagonet.CapInfo, wagonet.CapMDNS, wagonet.CapNTP, wagonet.CapTCP, wagonet.CapUDP}
	...
	wantImports := map[string]int{wagonet.Module: 1, wagonet.DNSModule: 6, wagonet.ICMPv4Module: 6, wagonet.MDNSModule: 10, wagonet.NTPModule: 6, wagonet.TCPModule: 11, wagonet.UDPModule: 6}
