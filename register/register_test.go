...
func TestAllProtocolFactoryHasExactRuntimeSurface(t *testing.T) {
	...
	wantCapabilities := []wago.Capability{wagonet.CapDHCPv4, wagonet.CapDNS, wagonet.CapICMPv4, wagonet.CapInfo, wagonet.CapIPv6, wagonet.CapLinkLocal4, wagonet.CapMDNS, wagonet.CapNTP, wagonet.CapTCP, wagonet.CapUDP}
	...
	wantImports := map[string]int{wagonet.Module: 1, wagonet.DHCPv4Module: 7, wagonet.DNSModule: 6, wagonet.ICMPv4Module: 6, wagonet.IPv6Module: 3, wagonet.LinkLocal4Module: 7, wagonet.MDNSModule: 10, wagonet.NTPModule: 6, wagonet.TCPModule: 11, wagonet.UDPModule: 6}
