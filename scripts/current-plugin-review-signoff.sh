...
readonly wago_go_mod_sha256=7b69104e706bc0978b0084ddfe738b8348175e301ab077aebfd39c172d2b98d4
...
echo 'current-plugin-review-signoff: PASS (pack-only local modules; initially empty GOMODCACHE with no module payload; network disabled; exact go.sum evidence; 4 capabilities; 24 imports; linked-child cleanup)'
